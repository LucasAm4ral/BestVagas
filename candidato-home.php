...
<?php
    try {
        $lista = CandidatoVaga::listar($logado);
    } catch(Exception $e) {
        Erro::trataErro($e);
    }
?>
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
    <center><h3 style="margin-top: 5%; margin-bottom: 3%;">Minhas Candidaturas</h3></center>
    <div class="row">
         <div class="col-md-12">
             <br>
              <table class="table table-dark">     
                   ...
                   <tbody>
                        <?php foreach ($lista as $linha): ?>
                             ...
                             <td><a href="deletar-cadastro.php?id=<?php echo $linha['idvaga'] ?>" class="btn btn-danger">Cancelar</a></td>
                             </tr>
                        <?php endforeach ?>
                   </tbody>
              </table>
